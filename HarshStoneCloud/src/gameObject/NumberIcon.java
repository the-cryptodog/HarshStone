...
import gameObject.NumberIconMoveState.NumberNoMove;
...
//        image = irc.tryGetImage(PathBuilder.getNumber(ImagePath.NUMBER));
        ...
        digits = number % 10;
        this.rate = rate;
        numbericonmovestate = new NumberNoMove();
    ...
    public void setNumberIconMoveState(NumberIconMoveState numbericonmovestate){
         this.numbericonmovestate = numbericonmovestate;    
    }
    
    public NumberIconMoveState getNumberIconMoveState(){
         return numbericonmovestate;    
    }
    
    public void move() {
        if (delaycounter.delayupdate()) {
            numbericonmovestate.action(this);
        }
    }
    ...
    public void paint(Graphics g){
        ...
        if(!(numbericonmovestate instanceof NumberMoveStop))
            if(tendigits == 0 ){
